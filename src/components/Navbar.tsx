                ...
                <li key={link.name}>
                  <Link 
                    ...
                    className={`block py-2 px-4 rounded-xl transition-all duration-300 ${
                      isActive 
                        ? 'bg-bukue-primary text-white shadow-md' // Estilo activo: Verde fuerte y texto blanco
                        : 'text-bukue-dark hover:text-bukue-primary hover:bg-bukue-accent' // Estilo inactivo
                    }`}
                  >
                    {link.name}
                  </Link>
