        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-4">
              <Link href="https://www.facebook.com/share/18C9U7tT12/" className="p-2 bg-white/5 rounded-full hover:bg-bukue-light transition-colors">
                <Facebook size={20} />
              </Link>
              <Link href="https://www.instagram.com/bukue_consultores" className="p-2 bg-white/5 rounded-full hover:bg-bukue-light transition-colors">
                <Instagram size={20} />
              </Link>
            </div>
          </div>
          ...
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-bukue-light pl-3">Empresa</h3>
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><Link href="/" className="hover:text-white flex items-center gap-2 tracking-wide">Inicio</Link></li>
              ...
              <li><Link href="https://wa.me/50688017441" className="hover:text-white flex items-center gap-2">Cita de Valoración</Link></li>
            </ul>
          </div>

          {/* Columna 3: Servicios */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-bukue-light pl-3">Servicios</h3>
            <ul className="space-y-4 text-gray-400 text-sm">
          ...
          {/* Columna 4: Contacto */}
          <div>
            <h3 className="text-lg font-bold mb-6 border-l-4 border-bukue-light pl-3">Contacto Directo</h3>
            <ul className="space-y-4 text-gray-400 text-sm">
