          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 pt-6">
              ...
              <p className="text-gray-500 text-lg leading-relaxed border-l-2 border-gray-100 pl-6">
                Compartimos análisis técnicos, guías de cumplimiento normativo y las innovaciones que estamos aplicando a la sostenibilidad en Costa Rica.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            return (
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-sm font-bold border transition-colors ${
                  activo
                    ? 'bg-bukue-dark border-bukue-dark text-white'
                    : 'bg-white border-gray-200 text-gray-500 hover:border-bukue-primary hover:text-bukue-dark'
                }`}
              >
                {cat}
              </button>
